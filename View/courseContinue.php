...
?>
    ...
    <div class="main-box">
        ...
        <div class="certificate-button">
            <div>
                <div><a class="enroll-button" href="../View/verifiedCertificate.php">Participation Certificate</a></div>
            </div>
            <div>
                <div><a class="enroll-button" href="../View/completeCertificate.php">Complete Cirtificate</a></div>
            </div>
        </div>
