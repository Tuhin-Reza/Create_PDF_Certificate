...
if (isset($_GET['param1']) && isset($_GET['param2'])) {
    ...
    if ($conn) {
        ...
        if (pg_num_rows($checkResult) > 0) {
            ...
            $participationDate = date("Y-m-d");
            $insertQuery = "INSERT INTO enrollDetails (userName, userEmail, courseName, instructorName,participationDate) 
                        VALUES (' $full_name', '$userEmail', '$param1', '$param2', '$participationDate')";
